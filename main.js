...
[1] How to determine player Turn (make counter if the counter got odd number it's X player turn) [ done ]
...
// Letting the user type his name and choose his letter 
...
button.addEventListener("click", function() {
    ...
    playerChoice == "X" ? guestChoice = "O" : guestChoice = "X";
...
for (let i = 0; i < box.length; i++) {
    box[i].addEventListener("click", function() {
        ...
        counter %2 == 0 ? box[i].innerHTML = playerChoice : box[i].innerHTML = guestChoice;
        // counter %2 == 0 ? box[i].innerHTML= playerChoice : box[i].innerHTML= playerChoice;
        // let playerChoice = box[i].innerHTML;
...
function gameEnds(i, playerName, playerChoice) {
    ...
    if (counter==9) console.log("Game Ended (Draw)");
}

/* 
Improvement options: 
[1] Let the user decide which letter he plays and enters his name [ done ].
[2] Show the score result. 
[3] Play again button.
[4] Congrats message at the end of the game. 
*/ 